...
const Learning = () => {
    ...
    return (
        <div className='bg-base-200'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 pt-3 pb-10 gap-[3rem] w-[75%]  mx-auto'>
            {
            ...
            <iframe className='w-full h-[20rem]'  style={{borderRadius:"20px", border:"1px solid gray"}} src="https://www.youtube.com/embed/vEnQtNcR4iA?si=KJ_w8aIyNx9KGlpM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
